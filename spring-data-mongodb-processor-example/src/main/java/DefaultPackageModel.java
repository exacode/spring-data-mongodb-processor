...
@Document
public class DefaultPackageModel {
	...
	private DefaultPackageModel modelValue;
	...
	public DefaultPackageModel getModelValue() {
		return modelValue;
	}

	public void setModelValue(DefaultPackageModel modelValue) {
		this.modelValue = modelValue;
	}

	public DefaultPackageModel[] getModelArray() {
		return modelArray;
	}

	public void setModelArray(DefaultPackageModel[] modelArray) {
		this.modelArray = modelArray;
	}

	public List<DefaultPackageModel> getModelList() {
		return modelList;
	}
